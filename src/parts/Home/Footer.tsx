  ...
  return (
    <footer>
      <div className="p-6 grid grid-cols-2">
        <div className="flex flex-col space-y-3 text-xs text-gray-500 font-bold">
          <div
            className="text-black text-opacity-75 inline-block h-[14px] w-14 mr-2 lazy-loaded"
            aria-hidden
          >
            <svg
              ...
              version="1.1"
              focusable="false"
              className="lazy-loaded fill-current"
            >
          ...
          <select
            name="language"
            id="language"
            className="form-select p-0 w-auto"
          >
      ...
      <div className="bg-gray-100 text-center py-4 text-gray-500 font-bold">
        Create by{" "}
        <a
          href="http://techpreneur.vercel.app/"
          target="_blank"
